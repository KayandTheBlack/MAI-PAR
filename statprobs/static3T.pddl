...
(define (problem static1)
  ...
  (:init
    ...
    (empty i1 i2)(empty i1 i3)(empty i1 i4)(empty i1 i5)(empty i2 i2)(empty i2 i3)(empty i2 i4)(empty i2 i5)(empty i3 i1)(empty i3 i2)(empty i3 i3)(empty i3 i5)(empty i4 i2)(empty i4 i3)(empty i4 i4)(empty i4 i5)(empty i5 i1)(empty i5 i2)(empty i5 i3)(empty i5 i4)(empty i5 i5)
    (at SP0 i1 i1)(at SP1 i4 i1)(at SP2 i2 i1)(at SP3 i3 i4)
  )
  (:goal
    (at SP0 i3 i3)
  )
